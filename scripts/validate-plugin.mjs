...
if (manifest.version !== "0.4.0" || claudeManifest.version !== manifest.version) throw new Error(`plugin manifest version drift: ${manifest.version}`);
...
for (const relative of [
  ...
  "dist/grammars/manifest.json",
  "dist/grammars/web-tree-sitter.wasm",
  "dist/grammars/tree-sitter-python.wasm",
  "dist/grammars/tree-sitter-c.wasm",
  "dist/grammars/tree-sitter-cpp.wasm"
]) {
...
if (version.stdout.trim() !== "0.4.0") throw new Error(`production CLI version mismatch: ${version.stdout.trim()}`);
